...
class HospitalAdminLoginScreen extends ConsumerStatefulWidget {
  const HospitalAdminLoginScreen({super.key});

  @override
  ConsumerState<HospitalAdminLoginScreen> createState() => _HospitalAdminLoginScreenState();
}

class _HospitalAdminLoginScreenState extends ConsumerState<HospitalAdminLoginScreen> {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (success && mounted) {
        ...
        if (user?.role == 'hospital_admin') {
          ...
          setState(() {
            _customRoleError = 'Access denied. The account is not registered as a hospital administrator.';
          });
  ...
  void _quickFillAdmin() {
    setState(() {
      _emailController.text = 'admin.mayo@mediqueue.com';
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Manage clinical schedules, monitor live queues, and handle emergency dispatchers.',
                      style: GoogleFonts.inter(
                        fontSize: 14,
                    ...
                    // Custom role error or auth provider error
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'admin.name@hospital.com',
                        hintStyle: GoogleFonts.inter(color: Colors.grey[400], fontSize: 13.5),
                        prefixIcon: Padding(
                          padding: const EdgeInsets.all(12),
                          child: SvgPicture.string(AdminFormSvgs.mail, width: 18, height: 18),
                        ),
                        filled: true,
                        ...
                        GestureDetector(
                          onTap: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('Please contact your hospital IT desk to recover admin credentials.'),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Padding(
                          padding: const EdgeInsets.all(12),
                          child: SvgPicture.string(AdminFormSvgs.lock, width: 18, height: 18),
                        ),
                        suffixIcon: IconButton(
                          icon: SvgPicture.string(
                            _obscurePassword ? AdminFormSvgs.eyeOff : AdminFormSvgs.eye,
                            width: 18,
                            height: 18,
                          ),
                          onPressed: () {
